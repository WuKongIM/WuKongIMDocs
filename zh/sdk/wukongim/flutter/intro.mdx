---
title: "SDK 介绍"
description: "WuKongIM Flutter SDK 设计理念、结构说明和核心功能介绍"
icon: "info"
---
...
<CardGroup cols={2}>
  <Card
    title="集成指南"
    icon="rocket"
    href="/zh/sdk/wukongim/flutter/integration"
  >
    了解如何在 Flutter 项目中集成 WuKongIM SDK
  </Card>
  <Card
    title="基础功能"
    icon="foundation"
  ...
  <Card
    title="消息管理"
    icon="message-circle"
    href="/zh/sdk/wukongim/flutter/message"
  >
    学习消息收发和历史消息查询
  </Card>
  <Card
